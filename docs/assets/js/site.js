...
function load() {
    ...
    // We generate our API from github.com/bigemap/bigemap.js/API.md
    ...
    ZeroClipboard.config({
        swfPath: window.location.origin + '/bigemap.js/assets/js/ZeroClipboard.swf',
