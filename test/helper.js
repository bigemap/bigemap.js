...
helpers.geocoderAustin = {
    ...
    "attribution": "<a href='https://www.bigemap.com/about/maps/' target='_blank'>&copy; Bigemap &copy; OpenStreetMap</a> <a class='bigemap-improve-map' href='https://www.bigemap.com/feedback/' target='_blank'>Improve this map</a>"
};
...
helpers.tileJSON = {
    ...
    "data":["http://a.tiles.bigemap.com/v3/examples.map-8ced9urs/markers.geojsonp"],
    "description":"Bird species of North America, gridded by species count.",
    "geocoder":"http://a.tiles.bigemap.com/v3/examples.map-8ced9urs/geocode/{query}.jsonp",
    "grids":["http://a.tiles.bigemap.com/v3/examples.map-8ced9urs/{z}/{x}/{y}.grid.json",
    ...
    "tilejson":"2.0.0",
    "tiles":["http://a.tiles.bigemap.com/v3/examples.map-8ced9urs/{z}/{x}/{y}.png",
...
helpers.tileJSON_improvemap = {
    ...
    "geocoder": "http://a.tiles.bigemap.com/v3/examples.h8e9h88l/geocode/{query}.jsonp",
...
helpers.tileJSON_street_terrain = {
    "attribution": "<a href=\"https://www.bigemap.com/about/maps/\" target=\"_blank\">&copy; Bigemap</a> <a href=\"http://www.openstreetmap.org/about/\" target=\"_blank\">&copy; OpenStreetMap</a> <a class=\"bigemap-improve-map\" href=\"https://www.bigemap.com/feedback/\" target=\"_blank\">Improve this map</a>",
    "bounds": [-180, -85.0511, 180, 85.0511],
    "center": [0, 0, 0],
    "format": "pbf",
    "maxzoom": 15,
    ...
    "scheme": "xyz",
    "tilejson": "2.0.0",
    "tiles": ["http://a.tiles.bigemap.com/v4/bigemap.bigemap-terrain-v2,bigemap.bigemap-streets-v6/{z}/{x}/{y}.vector.pbf?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejh2N21nMzAxMmQzMnA5emRyN2lucW0ifQ.jSE-g2vsn48Ry928pqylcg", "http://b.tiles.bigemap.com/v4/bigemap.bigemap-terrain-v2,bigemap.bigemap-streets-v6/{z}/{x}/{y}.vector.pbf?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejh2N21nMzAxMmQzMnA5emRyN2lucW0ifQ.jSE-g2vsn48Ry928pqylcg"],
    "vector_layers": [{
...
helpers.tileJSON_satellite_streets = {
    ...
    "scheme": "xyz",
    "tilejson": "2.0.0",
    "tiles": ["http://a.tiles.bigemap.com/v4/bigemap.bigemap-streets-v6,bigemap.satellite/{z}/{x}/{y}.vector.pbf?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejh2N21nMzAxMmQzMnA5emRyN2lucW0ifQ.jSE-g2vsn48Ry928pqylcg", "http://b.tiles.bigemap.com/v4/bigemap.bigemap-streets-v6,bigemap.satellite/{z}/{x}/{y}.vector.pbf?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejh2N21nMzAxMmQzMnA5emRyN2lucW0ifQ.jSE-g2vsn48Ry928pqylcg"],
    "vector_layers": [{
        "description": "",
        "fields": {
            "class": "One of: park, cemetery, hospital, school, industrial, parking, pitch, piste, agriculture, wood, scrub, grass, sand, rock, glacier",
...
helpers.tileJSON_autoscale = {
  ...
  "name": "dot default",
  "minzoom": 0,
  "attribution": "<a href='http://bigemap.com/about/maps' target='_blank'>Terms & Feedback</a>",
  "autoscale": true,
  "bounds": [
    -180,
    -85,
  ...
  "data": [
    "http://a.tiles.bigemap.com/v3/tmcw.map-oitj0si5/markers.geojsonp"
  ],
  "geocoder": "http://a.tiles.bigemap.com/v3/tmcw.map-oitj0si5/geocode/{query}.jsonp",
