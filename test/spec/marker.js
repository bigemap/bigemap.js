describe('L.bigemap.marker', function () {
  ...
  describe('#style', function () {
    it('produces a small marker', function () {
      ...
      expect(marker.options.icon.options.iconUrl).to.eql(
        internals.url('/v2/marker/pin-s+52a1d8.png')
      );
    });
    ...
    it('uses @2x suffix on retina', function () {
      ...
      expect(marker.options.icon.options.iconUrl).to.eql(
        internals.url('/v2/marker/pin-s+52a1d8@2x.png')
      );
    });
    ...
    it('supports custom access token', function () {
      ...
      expect(marker.options.icon.options.iconUrl).to.eql(
        internals.url('/v2/marker/pin-s+52a1d8.png', 'custom')
      );
    });
    ...
    it("sets a marker's title", function () {
      ...
      expect(marker.options.title).to.eql('test');
    });
  ...
  describe('#icon', function () {
    it('produces an icon', function () {
      ...
      expect(icon.options.iconUrl).to.eql(
        internals.url('/v2/marker/pin-l+52a1d8.png')
      );
    });
    ...
    it('supports custom access token', function () {
      ...
      expect(icon.options.iconUrl).to.eql(
        internals.url('/v2/marker/pin-l+52a1d8.png', 'custom')
      );
    });

    it("supports integer 'marker-symbol' values", function () {
      expect(
        L.bigemap.marker.icon({ 'marker-symbol': 0 }).options.iconUrl
      ).to.eql(internals.url('/v2/marker/pin-m-0+52a1d8.png'));
      expect(
        L.bigemap.marker.icon({ 'marker-symbol': 1 }).options.iconUrl
      ).to.eql(internals.url('/v2/marker/pin-m-1+52a1d8.png'));
    });

    it("supports 'marker-symbol' with empty string", function () {
      expect(
        L.bigemap.marker.icon({ 'marker-symbol': '' }).options.iconUrl
      ).to.eql(internals.url('/v2/marker/pin-m+52a1d8.png'));
    });
  });
