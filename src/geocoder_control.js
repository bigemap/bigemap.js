...
var GeocoderControl = L.Control.extend({
    ...
    onAdd: function(map) {
        ...
        var container = L.DomUtil.create('div', 'leaflet-control-bigemap-geocoder leaflet-bar leaflet-control'),
            link = L.DomUtil.create('a', 'leaflet-control-bigemap-geocoder-toggle bigemap-icon bigemap-icon-geocoder', container),
            results = L.DomUtil.create('div', 'leaflet-control-bigemap-geocoder-results', container),
            wrap = L.DomUtil.create('div', 'leaflet-control-bigemap-geocoder-wrap', container),
            form = L.DomUtil.create('form', 'leaflet-control-bigemap-geocoder-form', wrap),
